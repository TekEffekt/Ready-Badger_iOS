...
class CalloutAnnotation : MKPointAnnotation {
    ...
    let underlyingAnnotation: CustomAnnotation
    ...
    override var coordinate: CLLocationCoordinate2D {
        get {
            return underlyingAnnotation.coordinate
        }
        set {
            underlyingAnnotation.coordinate = newValue
        }
    }
    ...
    override var title: String? {
        ...
        set {
            underlyingAnnotation.title = newValue
        }
    }
}
